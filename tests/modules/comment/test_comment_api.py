...
class TestCommentApi(BaseTestComment):
    ...
    def test_comments_are_task_isolated(self) -> None:
        ...
        assert response1.status_code == 200
        self.assert_pagination_response(response1.json, expected_items_count=1, expected_total_count=1)
        ...
        assert response2.status_code == 200
        self.assert_pagination_response(response2.json, expected_items_count=1, expected_total_count=1)
